...
def anomaly_detection(input_data):
...
#moving out of this input function let's define the main function
def main():
    
    #giving our page a title
    ...
    if st.button('Run Sniffer'):
        detection = anomaly_detection([id, dur, proto, 
                                   service, spkts, 
                                   dpkts, rate, 
                                   dttl, dload, 
                                   dintpkt, djit, 
